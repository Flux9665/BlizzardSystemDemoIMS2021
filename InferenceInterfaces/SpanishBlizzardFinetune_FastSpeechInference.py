...
class FastSpeech2(torch.nn.Module, ABC):
    ...
    def __init__(self,  # network structure related
        ...
        self.load_state_dict(torch.load(os.path.join("Models", "FastSpeech2_Blizzard_Finetune", "best.pt"), map_location='cpu')["model"])
...
class SpanishBlizzard_FastSpeechInference(torch.nn.Module):
