...
class FastSpeech2(torch.nn.Module, ABC):
    ...
    def __init__(self,  # network structure related
        ...
        self.load_state_dict(torch.load(os.path.join("Models", "FastSpeech2_SpanishBig", "best.pt"), map_location='cpu')["model"])
...
class SpanishBig_FastSpeechInference(torch.nn.Module):
